...
foreach($line in $csvMembre){
    ...
    Write-Host "Ajout de $matricule - $nomComplet ..." -ForegroundColor Yellow
    ...
    if(!$ouName -or !$userPath){
        
        Write-Host "NNNNNNOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOON" -ForegroundColor DarkCyan
    ...
    Write-Host "$matricule - $nomComplet Ajouté avec succès" -ForegroundColor Green
    ...
    icacls $cheminProfil  /grant $matricule":(CI)(OI)(M)"
...
icacls $dossiersPerso  /grant "HYRULE\Admins du domaine:(CI)(OI)(F)"
icacls $dossiersPerso  /grant "système:(CI)(OI)(F)"
icacls $dossiersPerso  /grant "HYRULE\Gestionnaires:(CI)(OI)(RX)"

icacls $dossiersProfils  /grant "HYRULE\Admins du domaine:(CI)(OI)(F)"
icacls $dossiersProfils  /grant "système:(CI)(OI)(F)"
icacls $dossiersProfils  /grant "HYRULE\Gestionnaires:(CI)(OI)(RX)"
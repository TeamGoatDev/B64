...
if($name = Get-NetAdapter -Name "Ethernet 4")
{
    ...
    Rename-NetAdapter -Name $name -NewName "WAN";
    ...
    New-VMSwitch -Name Comm_EXTERNE -NetAdapterName WAN
    ...
    New-NetIPAddress -InterfaceAlias $name -PrefixLength 24 -IPAddress 192.168.64.100; 
